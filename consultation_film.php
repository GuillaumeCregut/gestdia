...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * 																	 *
 * Nom de la page :	consultation_film.php							 *
...
//Assignations des objets utiles
	...
	//On selectionne les boitiers dans la base
	$SQLS=$SelFilm;
	$Result=$Conn->sql_fetch_all($SQLS);
	$moteur->assign('TabFilm',$Result);
	$moteur->display($CheminTpl.'consultation_film.tpl');
