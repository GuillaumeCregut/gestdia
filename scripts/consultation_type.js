...
function affiche(indice,marque,boitier)
{
	...
	xhr.open("POST","ajax_filmstype.php",true); //on appelle la page avec la méthode post en asychrone
	xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
	xhr.send("Id_Type="+indice);  //ID post sera le $_POST[''] et ValuePost sa valeur	
}